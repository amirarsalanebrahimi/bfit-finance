...
const authConfigContent = computed<AuthConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            title: 'ورود با کد بازیابی',
            description: 'یکی از کدهای بازیابی اضطراری را وارد کنید، تا دسترسی به حساب کاربری شما تأیید شود',
            toggleText: 'ورود با رمز دو مرحله ای',
        };
    }

    return {
        title: 'ورود با رمز دو مرحله ای',
        description: 'رمز دوم ارائه شده توسط برنامه احراز هویت خود را وارد کنید',
        ...
        <div class="space-y-6">
            <template v-if="!showRecoveryInput">
                <Form v-bind="store.form()" class="space-y-4" reset-on-error @error="code = []" #default="{ errors, processing, clearErrors }">
                    ...
                    <Button type="submit" class="w-full" :disabled="processing">ادامه</Button>
